...
export default {
    ...
    get state() {
        return atom.config.get('macos-dark-mode.automaticMode');
    },
    ...
    activate() {
        ...
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            ...
            'dark-mode:Enable Auto Mode': () => atom.config.set('macos-dark-mode.automaticMode', true),
            'dark-mode:Disbale Auto Mode': () => atom.config.set('macos-dark-mode.automaticMode', false)}),
            atom.config.onDidChange('macos-dark-mode.automaticMode', ({newValue}) => {
                if (newValue) {
    ...
    toggle() {
        ...
        atom.config.set('macos-dark-mode.automaticMode', false);
    ...
    _startupNotification() {
        atom.notifications.addInfo(`Dark Mode: Automatic mode is ${this.state ? 'ON' : 'OFF'}`, {
            ...
            buttons: [{
                ...
                onDidClick() {
                    atom.config.set('macos-dark-mode.automaticMode', !this.state);
                }
            }]
        });
    }
