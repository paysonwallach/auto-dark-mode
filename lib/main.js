...
export default {
    ...
    activate() {
        ...
        this.subscriptions.add(atom.commands.add('atom-workspace', {
            ...
            atom.config.onDidChange('mojave-dark-mode.automaticMode', ({newValue}) => {
                ...
                atom.notifications.addInfo(`Dark Mode: Automatic theme switching is ${newValue ? 'enabled' : 'disabled'}`, notificationsOptions);
            })
        );
    ...
    _startupNotification() {
        atom.notifications.addInfo(`Dark Mode: Automatic theme switching is ${this.state ? 'enabled' : 'disabled'}`, {
            icon: 'light-bulb',
            buttons: [{
